...
function buildMenuItems(schema) {
  ...
  if (type = schema.marks.u)
    r.toggleU = markItem(type, {title: "Toggle underline", icon: icons.em})
  ...
  r.inlineMenu = [cut([r.toggleStrong, r.toggleEm, r.toggleU, r.toggleCode, r.toggleLink]), [r.insertMenu]]
